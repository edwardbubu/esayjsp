	...
	<head>
		...
		<script type="text/javascript">
			...
			function getSelected(){
				var selected = $('#supplier').datagrid('getSelected');				
				if (selected){
			...
			function getSelections(){
				var ids = [];
				var rows = $('#supplier').datagrid('getSelections');
			...
			function selectRow(){
				$('#supplier').datagrid('selectRow',2);
			}
			function selectRecord(){
				$('#supplier').datagrid('selectRecord','002');
			}
			function unselectRow(){
				$('#supplier').datagrid('unselectRow',2);
			}
			function mergeCells(){
				$('#supplier').datagrid('mergeCells',{
					index:2,
					field:'addr',
					rowspan:2,
					colspan:2
