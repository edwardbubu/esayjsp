		...
		<div region="north" border="true" class="cs-north">
			<div class="cs-north-bg">
				...
				<ul class="ui-skin-nav">
					...
					<li>
						<span><a href="login.jsp" class="easyui-linkbutton">注销</a>
						</span>
					</li>
				</ul>
		...
		<div id="mainPanle" region="center" border="true" border="false">
			<div id="tabs" class="easyui-tabs" fit="true" border="false">
				<div title="Home">
	              ...
	              %>
		          <div>你好，<%=user.getUsername()%></div>
	             <div id="w" class="easyui-window" title="站内信息" data-options="iconCls:'icon-save'" style="width:500px;height:200px;padding:10px;">
		        <%
				      SystemUser user1 = (SystemUser)session.getAttribute("user");
	              %>
		          <div>你好，<%=user1.getUsername()%></div>
	            </div>
			</div>
